...
export class TradeType1732227249371 implements MigrationInterface {
    name = 'TradeType1732227249371'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`trades\` ADD \`type\` enum ('sale', 'purchase') NOT NULL DEFAULT 'sale'`);
