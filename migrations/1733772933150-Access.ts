...
export class Access1733772933150 implements MigrationInterface {
    name = 'Access1733772933150'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`access\` (\`id\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`path\` varchar(255) NOT NULL, \`isActive\` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`role_access\` (\`id\` varchar(255) NOT NULL, \`roleId\` varchar(36) NULL, \`accessId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
