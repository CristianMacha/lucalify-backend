...
export class AddPricePurchase1732383862694 implements MigrationInterface {
    name = 'AddPricePurchase1732383862694'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`pricePurchase\` decimal(10,2) NOT NULL DEFAULT '0.00'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`pricePurchase\``);
    }
