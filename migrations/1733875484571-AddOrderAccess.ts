...
export class AddOrderAccess1733875484571 implements MigrationInterface {
    name = 'AddOrderAccess1733875484571'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`access\` ADD \`order\` tinyint NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`ALTER TABLE \`role_access\` DROP FOREIGN KEY \`FK_22f7449755b215241996e12f018\``);
        await queryRunner.query(`ALTER TABLE \`role_access\` DROP FOREIGN KEY \`FK_d49b4a1ea909dd305982da6b749\``);
        await queryRunner.query(`ALTER TABLE \`role_access\` CHANGE \`roleId\` \`roleId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`role_access\` CHANGE \`accessId\` \`accessId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`role_access\` ADD CONSTRAINT \`FK_22f7449755b215241996e12f018\` FOREIGN KEY (\`roleId\`) REFERENCES \`roles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`role_access\` ADD CONSTRAINT \`FK_d49b4a1ea909dd305982da6b749\` FOREIGN KEY (\`accessId\`) REFERENCES \`access\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`role_access\` CHANGE \`accessId\` \`accessId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`role_access\` CHANGE \`roleId\` \`roleId\` varchar(36) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`role_access\` ADD CONSTRAINT \`FK_d49b4a1ea909dd305982da6b749\` FOREIGN KEY (\`accessId\`) REFERENCES \`access\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`role_access\` ADD CONSTRAINT \`FK_22f7449755b215241996e12f018\` FOREIGN KEY (\`roleId\`) REFERENCES \`roles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`role_permissions\` ADD CONSTRAINT \`FK_06792d0c62ce6b0203c03643cdd\` FOREIGN KEY (\`permissionId\`) REFERENCES \`permissions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`role_permissions\` ADD CONSTRAINT \`FK_b4599f8b8f548d35850afa2d12c\` FOREIGN KEY (\`roleId\`) REFERENCES \`roles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`access\` DROP COLUMN \`order\``);
    }
